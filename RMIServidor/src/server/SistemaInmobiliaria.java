...
public class SistemaInmobiliaria extends UnicastRemoteObject implements TDASistemaInmobiliaria {
	...
	protected SistemaInmobiliaria() throws RemoteException {
		super();
	}
	
	public static SistemaInmobiliaria getInstance() throws RemoteException {
        if (instance == null) {
